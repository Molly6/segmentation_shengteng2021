...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        # loss_decode=dict(
        #     type='FocalLoss2d', use_sigmoid=False, loss_weight=1.0)
        # loss_decode=dict(
        #     type='LabelSmoothingCrossEntropy', smoothing=0.05, loss_weight=1.0)
        loss_decode=dict(
    ...
    auxiliary_head=dict(
        ...
        align_corners=False,
        # loss_decode=dict(
        #     type='FocalLoss2d', use_sigmoid=False, loss_weight=0.4),
        # loss_decode=dict(
        #     type='LabelSmoothingCrossEntropy', smoothing=0.05, loss_weight=0.4)
        loss_decode=dict(
...
train_pipeline = [
    ...
    # dict(type='RandomRotate', prob=0.5, degree=(0, 90)),
